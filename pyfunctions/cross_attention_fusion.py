"""Bidirectional cross-attention fusion for RGB-HSI feature alignment.
RGB is treated as the fine spatial grid; HSI as the coarse grid. Each HSI parent cell attends to
its NxN RGB children (N inferred at runtime) and vice versa. Spectral tokens are collapsed via
SpectralSE then gated into the RGB stream."""
